 ...
 \end{frame}
   ...
   \begin{frame}
	...
	\begin{itemize}
		\item Euler equation:
		\begin{align*}
%			 \hat{z}_t + [\alpha + \delta^{-1}(1-\delta)] \hat{k}_{t-1} - (1-s_c)\delta^{-1}\hat{k}_{t} - s_c \hat{c}_{t+1} + \gamma^{-1} s_c(1 - \beta(1-\delta)) [\hat{z}_{t+1} + (\alpha-1) \hat{k}_t] &= 0 \\
...
%		\item Production function:
%		\begin{align*}
%			s_c \hat{c}_t   = \hat{z}_t + [\alpha + \delta^{-1}(1-\delta)] \hat{k}_{t-1} - (1-s_c)\delta^{-1}\hat{k}_{t}
%		\end{align*}
	 \end{itemize}
 \end{frame}
